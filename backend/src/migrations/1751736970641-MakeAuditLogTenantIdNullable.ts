...
export class MakeAuditLogTenantIdNullable1751736970641
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('workshop', 'washers', 'pickup_delivery_planners', 'wash_planners', 'garage_admin', 'super_admin')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."file_category" RENAME TO "file_category_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."files_category_enum" AS ENUM('profile_photo', 'tenant_logo', 'vehicle_photo', 'wash_before', 'wash_after', 'damage_report', 'invoice', 'document', 'other')`,
    );
    await queryRunner.query(
      `ALTER TABLE "files" ALTER COLUMN "category" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "files" ALTER COLUMN "category" TYPE "public"."files_category_enum" USING "category"::"text"::"public"."files_category_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "files" ALTER COLUMN "category" SET DEFAULT 'other'`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "files" ADD CONSTRAINT "FK_484acb2ff8f3e134dfac8f01e8a" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "files" DROP CONSTRAINT "FK_484acb2ff8f3e134dfac8f01e8a"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."file_category_old" AS ENUM('profile_photo', 'tenant_logo', 'vehicle_photo', 'wash_before', 'wash_after', 'damage_report', 'invoice', 'document', 'other')`,
    );
    await queryRunner.query(
      `ALTER TABLE "files" ALTER COLUMN "category" DROP DEFAULT`,
    );
    await queryRunner.query(
      `ALTER TABLE "files" ALTER COLUMN "category" TYPE "public"."file_category_old" USING "category"::"text"::"public"."file_category_old"`,
    );
    await queryRunner.query(
      `ALTER TABLE "files" ALTER COLUMN "category" SET DEFAULT 'other'`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."file_category_old" RENAME TO "file_category"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_old" AS ENUM('workshop', 'washers', 'pickup_delivery_planners', 'wash_planners', 'garage_admin', 'super_admin')`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "role" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "files" ADD CONSTRAINT "FK_files_tenant_id" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
