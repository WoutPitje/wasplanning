...
**Wasplanning Backend API** - NestJS application providing multi-tenant wash planning services.
...
- **MinIO file storage** - S3-compatible object storage for photos
- **Swagger API documentation** - Complete API documentation at `/api/docs`
- **Multi-location support** - Users can be assigned to multiple locations within their tenant
